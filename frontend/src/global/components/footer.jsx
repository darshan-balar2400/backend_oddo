...
const Footer = () => {
    return <footer className="relative py-20 flex flex-col items-center bg-cyan-900 overflow-hidden md:py-40">
                ...
                <div className="flex flex-wrap items-center justify-between md:flex-nowrap">
                    <div className="w-full space-x-12 flex justify-center text-gray-300 sm:w-7/12 md:justify-start">
                        <ul className="list-disc list-inside space-y-8">
                            ...
                            <li><Link href="/contact-us" className="hover:text-sky-400 transition">Contact</Link></li>
                        ...
                        <ul role="list" className="space-y-8">
                            ...
                            <li>
                                <a href="#" className="flex items-center space-x-3 hover:text-sky-400 transition">
                                    <img className="w-5 h-5" src="https://c5.patreon.com/external/favicon/favicon.ico?v=69kMELnXkB" alt="patreon icon" />                                        <span>Patreon</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" className="flex items-center space-x-3 hover:text-sky-400 transition">
