...
const Alertdialog = () => {
    ...
    return <div className={`fixed ${visibility ? "block" : "hidden"} inset-0 pointer-events-auto z-10 overflow-y-auto transition-all duration-300`} aria-labelledby="modal-title" role="dialog" aria-modal="true">
